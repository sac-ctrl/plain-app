...
export const gameList: GameDef[] = [
  ...
  },
  {
    ...
    icon: '🚀',
    desc: 'Drag to fly. Auto-fire. Beat 5 acts of bosses.',
    badge: 'New',
    rating: 4.9,
    gradient: 'linear-gradient(135deg, #02123A, #6366f1, #ec4899)',
    modes: ['Campaign', 'Endless', 'BossRush', 'Daily'],
    tutorial: {
      tagline: 'Tactile, explosive, silky smooth — every tap fires, every swipe dodges.',
      howTo: [
        'Drag anywhere on screen — your ship follows your finger 1:1.',
        'You auto-fire 5 shots/sec; double-tap to drop an overdrive bomb when charged.',
        'Long press to charge a railgun shot that pierces through enemies.',
        'Grab power-ups: shield, slow-time, magnet, +1 life, double damage.',
        'Each act is 10 waves + a multi-phase boss. Beat 5 acts to clear the campaign.',
      ],
      controls: [
        { key: 'Drag', action: 'Move ship 1:1' },
        { key: 'Tap halves', action: 'Step left/right (assist)' },
        { key: 'Double tap', action: 'Overdrive bomb' },
        { key: 'Long press', action: 'Charged railgun' },
        { key: 'Tilt', action: 'Optional gyro steering' },
        { key: '← → / A D', action: 'Keyboard move' },
        { key: 'Space', action: 'Overdrive (keyboard)' },
        { key: 'Shift', action: 'Charged shot (keyboard)' },
      ],
      features: [
        ...
        'Voice announcer (Wave clear, Boss approaching, Critical health)',
        'Haptics: shot tick, kill buzz, hit punch, boss triple',
        'Accessibility: colorblind, reduced motion, high contrast, assist mode, auto-fire, larger hitbox, one-handed, big HUD, battery saver',
        'Daily seeded run with shareable challenge code',
        'Login streak rewards',
      ],
      tips: [
        'Stay in motion — parking gets you sniped.',
        'Bait swarmers across the screen, then sweep them with your beam.',
        'Save overdrive for elite waves and boss phase 2.',
        'Magnet vacuums power-ups across the lane — pop it before tank waves.',
      ],
    },
