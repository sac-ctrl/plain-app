...
object GamesRegistry {
    val all: List<GameMeta> = listOf(
        ...
        GameMeta("space", "Space Hunter · Nebula Strike", "Drag-to-fly. Auto-fire. Beat the boss.",
            Color(0xFF02123A), Color(0xFF7CE7FF), listOf("Classic", "Survival", "Boss"),
            GameTutorial(
                howTo = listOf(
                    "Drag to fly your ship across the screen.",
                    "Auto-fire keeps you focused on dodging.",
                    "Pick a perk at the start of every life.",
                    "Grab power-ups (weapon, shield, life, dmg, slow, energy, bomb).",
                    "Charge energy → double-tap for an Overdrive homing salvo.",
                ),
                controls = listOf(
                    GameControl("Drag", "Move ship"),
                    GameControl("Tap", "Manual fire (when auto-fire is off)"),
                    GameControl("Long-press", "Charged shot (×3 damage)"),
                    GameControl("Double-tap", "Overdrive (homing salvo)"),
                ),
                features = listOf(
                    "6 enemy types incl. tank, sniper, mothership, elite, spawnling",
                    "Multi-phase boss every 3 waves with HP bar",
                    "7 power-up types with magnetic pickup",
                    "Combo multiplier and i-frames after every hit",
                    "4 ship hulls (Interceptor, Brawler, Stealth, Healer)",
                    ...
                    "Settings: haptics, reduced motion, high contrast, battery saver, one-handed, 3 assists",
        ...
        GameMeta("g2048", "2048: Merger Ascension", "5 modes · 4–6 grids · skins, themes, daily seed, post-game heatmap",
            Color(0xFF22150B), Color(0xFFFFA94D), listOf("Classic", "Time", "Survival", "Challenge", "Daily"),
            GameTutorial(
                howTo = listOf(
                    "Swipe, arrow-key or tilt to slide every tile in that direction.",
                    "Two equal tiles merge into one of double value.",
                    "Five modes: Classic to 2048, Timed dash, Endless expanding grid, Challenge puzzles, Daily seed.",
                    "Earn power-ups (undo, shuffle, lowest-tile clear) refilled daily.",
                ),
                controls = listOf(
                    GameControl("Swipe / Tilt", "Slide tiles"),
                    GameControl("⚙", "Open settings, modes, themes, skins, accessibility"),
                ),
                features = listOf(
                    "5 modes: Classic · Timed · Endless · Challenge · Daily",
                    "4×4, 5×5, 6×6 grids — unlock with milestones",
                    "4 themes and 6 tile skins (digital · neon · marble · wood · crystal · classic)",
                    "Animated tile sliding, post-game cell heat-map and best-tile chart",
                    "On-screen arrows, tilt, swipe-distance slider",
                    "Reduced motion, high contrast, one-handed, battery-saver, colourblind, font scale",
                    "Assists: hints, auto-undo, slow animations, next-tile preview",
                    "Adaptive difficulty, daily seed, settings persisted",
                ),
                tips = listOf(
                    "Pick a corner and lock your largest tile there.",
                    "Chain three merges in one swipe for a combo bonus.",
                    "In Endless, save the shuffle for after the grid expands to 5×5.",
                ),
            )),
        GameMeta("memory", "Recall · Twin Echo", "6 themes, 5 modes, daily power-ups",
            ...
            GameTutorial(
                howTo = listOf(
                    ...
                    "Spend daily power-ups (Reveal / Shuffle / Freeze) when you get stuck.",
                ),
                controls = listOf(
                    GameControl("Tap", "Flip card"),
                    GameControl("Long-press", "Confirm flip (motor accessibility)"),
                ),
                features = listOf(
                    ...
                    "Adaptive hint after 3 misses in a row",
                    "Colourblind shape tags, high contrast, reduced motion",
                    "Assists: auto-match after 2 misses, longer reveal, large touch zones",
                    "One-handed layout and battery saver",
                    "Settings persist via DataStore",
                ),
                tips = listOf(
                    "Spread your first flips so you build a mental map fast.",
                    "Hold a Reveal for the last 4 cards.",
        ...
        GameMeta("tap", "Pattern Pulse", "4 modes · sequence · rhythm · shape · cascade · sound packs · post-game stats",
            Color(0xFF1B1040), Color(0xFFFFD166), listOf("Sequence", "Rhythm", "Shape", "Cascade"),
            GameTutorial(
                howTo = listOf(
                ...
                controls = listOf(
                    GameControl("Tap", "Tap a pad / note / tile"),
                    GameControl("⚙", "Switch mode, sound pack, theme, accessibility"),
                ),
                features = listOf(
                    "4 modes: Sequence · Rhythm · Shape · Cascade",
                    "4, 6, or 9 pads (4-lane in rhythm mode)",
                    "4 themes (synth · particles · dark · nature) and 4 sound packs (piano · drums · synth · 8-bit)",
                    "4 tap effects unlock with combo milestones",
                    "Power-ups: hint, slow-motion, extra life — refilled daily",
                    "Adaptive timing window, multi-touch, calibration metronome, daily seed",
                    "Post-game pad heat-map and timing histogram",
                    "Reduced motion, high contrast, one-handed, battery-saver, colourblind glyphs",
                    "Assists: glow next pad, larger tap radius, wider timing window",
                ),
                tips = listOf(
                    "Hum the rhythm in your head.",
                    "Watch the spawn line, not the hit line, in Rhythm mode.",
